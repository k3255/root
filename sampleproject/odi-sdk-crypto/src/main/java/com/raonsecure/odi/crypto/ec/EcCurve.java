	...
	public EcPoint decodePoint(byte[] encodedPoint) {
		...
		case 0x03:
			...
			if (bit0 == ytilde) {
				...
				p = new EcPoint(this, x,
						new EcFieldElement(this._q, _q.subtract(beta.toBigInteger())),
						true);
			}
			break;
		case 0x04:
		...
		case 0x07:
			...
			p = new EcPoint(this, new EcFieldElement(this._q, new BigInteger(1, xEnc)),
					new EcFieldElement(this._q, new BigInteger(1, yEnc)));
			break;
		default:
			throw new RuntimeException(
					"Invalid encoding 0x" + Integer.toString(encodedPoint[0], 16));
		}
		return p;
	}
