...
public class EcTools {
	...
	public static CurveParam getCurveParam(int curveType) {
		...
		if (null == sCurveParams[curveType]) {
			if (CurveParam.SECP256_K1 == curveType) {
				sCurveParams[CurveParam.SECP256_K1] = new CurveParam(
				...
				sCurveParams[CurveParam.SECP256_R1] = new CurveParam(
						CurveParam.SECP256_R1,
	...
	public static EcPoint sumOfTwoMultiplies(EcPoint P, BigInteger k, EcPoint Q,
			BigInteger l) {
	...
	public static EcPoint decompressKey(CurveParam param, BigInteger x,
			boolean firstBit) {
