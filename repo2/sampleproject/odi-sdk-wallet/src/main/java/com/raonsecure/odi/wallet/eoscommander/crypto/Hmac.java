...
package com.raonsecure.odi.wallet.eoscommander.crypto;
...
public class Hmac {
	...
	private static byte[] hmac(MessageDigest digest, int blockSize, byte[] key,
			byte[] message) {
	...
	public static boolean testTestVectors() {
		...
		// Test case 1
		key = Base16.toBytes("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b");
		data = Base16.toBytes("4869205468657265");
		expected_256 = Base16.toBytes(
				"b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7");
		expected_512 = Base16.toBytes(
				"87aa7cdea5ef619d4ff0b4241a1d6cb02379f4e2ce4ec2787ad0b30545e17cdedaa833b7d6b8a702038b274eaea3f4e4be9d914eeb61f1702e696c203a126854");
		result_256 = Hmac.hmacSha256(key, data);
		result_512 = Hmac.hmacSha512(key, data);
		if (!BitUtils.areEqual(result_256, expected_256)
				|| !BitUtils.areEqual(result_512, expected_512)) {
			return false;
		}

		// Test case 2
		key = Base16.toBytes("4a656665");
		data = Base16
				.toBytes("7768617420646f2079612077616e7420666f72206e6f7468696e673f");
		expected_256 = Base16.toBytes(
		...
		// Test case 3
		key = Base16.toBytes("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		data = Base16.toBytes(
		...
		result_256 = Hmac.hmacSha256(key, data);
		result_512 = Hmac.hmacSha512(key, data);
		return !(!BitUtils.areEqual(result_256, expected_256)
				|| !BitUtils.areEqual(result_512, expected_512));
	}
